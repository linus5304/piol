...
import { ChevronLeft, ChevronRight, ImageOff, MessageCircle, X } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 bg-black">
          <div className="absolute top-4 right-4 z-20">
            <Button
              ...
              className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full text-white"
            >
              <X className="w-5 h-5" />
            </Button>
          </div>
          <div className="h-full flex items-center justify-center">
            ...
            <Button
              ...
              className="absolute left-4 w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full text-white z-10"
            >
            ...
            <Button
              ...
              className="absolute right-4 w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full text-white z-10"
            >
